...
PushManager.prototype.sendUsers = function (users, payload) {
...
PushManager.prototype.subscribe = function (deviceInfo) {
    this.pushAssociationManager.add(deviceInfo.user, deviceInfo.type, deviceInfo.token);
};

PushManager.prototype.unsubscribeDevice = function (deviceToken) {
    this.pushAssociationManager.removeDevice(deviceToken);
};

PushManager.prototype.unsubscribeUser = function (user) {
